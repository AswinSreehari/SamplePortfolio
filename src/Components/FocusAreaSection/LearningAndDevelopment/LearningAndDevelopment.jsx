...
dynamic knowledge exchange and ideation.`
  ...
  return (
      ...
      <h4 className="text-7xl absolute font-6rem font-bold font-[lato, sans] text-black top-890 left-20 m-5 shadow-2s" >Learning And Development</h4>
       <div className="text-3xl w-200 m-5 text-gray-500 absolute top-930 left-20 font-[lato, sans] font-bold">
          <BlurTextElement text={text} />
       </div>
       <div  className=" w-50% absolute top-900 right-20">
