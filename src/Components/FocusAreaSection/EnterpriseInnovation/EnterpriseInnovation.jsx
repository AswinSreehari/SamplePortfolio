...
dynamic knowledge exchange and ideation.`
  return (
    <div className="flex flex-row items-center justify-between h-screen mt-14">
      <h4 className="text-7xl absolute font-6rem font-bold font-[lato, sans] text-black top-390 left-20 m-5 shadow-2xs" >Enterprise Innovation</h4>
       <div className="text-3xl w-200 m-5 text-gray-500 absolute top-415 left-20 font-[lato, sans] font-bold">
        
          <BlurText text={text} />
       </div>
       <div  className=" w-50% absolute top-370 right-20">
